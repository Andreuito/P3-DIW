    ...
    <footer class="text-center bg-gray-800 text-white" aria-labelledby="footerHeading">
        <div class="container flex flex-col justify-center items-center px-6 pt-6">
            ...
            <div class="flex justify-center mb-6">
                ...
                <a href="#!" type="button"
                    class="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="Referenceedin-in"
                        class="w-3 h-full mx-auto" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        <path fill="currentColor"
            ...
            <div class="mb-6">
                <p class="text-gray-500 text-base">
                    SaturnCars is a car dealership that sells new and used cars. We also offer financing,
                    service,
                    and parts.
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 space-x-10">
                ...
                <div class="mb-6">
                    <h5 class="uppercase font-bold mb-2.5">References</h5>

                    <ul class="list-none mb-0">
                        <li>
                            <a href="https://www.tesla.com" class="text-white">Reference 1</a>
                        </li>
                        <li>
                            <a href="https://www.hyundai.com/es.html" class="text-white">Reference 2</a>
                        </li>
                        <li>
                            <a href="#!" class="text-white">Reference 3</a>
                        </li>
                        <li>
                            <a href="#!" class="text-white">Reference 4</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <ul class="list-none mb-0">
                        <li>
                            <a href="#!" class="text-white">Reference 1</a>
                        </li>
                        <li>
                            <a href="#!" class="text-white">Reference 2</a>
                        </li>
                        <li>
                            <a href="#!" class="text-white">Reference 3</a>
                        </li>
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.2);">
            © 2023 Copyright:
            <a class="text-white" href="https://tailwind-elements.com/">SaturnCars Vehicles</a>
        </div>
    </footer>
</template>